            ...
            <?php if($this->style == 'type1'): ?>
                ...
                <div class="event-carousel-type2-head clearfix">
                    ...
                    <div class="mec-event-footer-carousel-type2">
                        ...
                        <?php endif; ?>
                        <?php echo $this->display_link($event, ((is_array($event->data->tickets) and count($event->data->tickets) and !strpos($soldout, '%%soldout%%') and !$this->booking_button) ? $this->main->m('register_button', __('REGISTER', 'mec')) : $this->main->m('view_detail', __('View Detail', 'mec'))), 'mec-booking-button mec-bg-color-hover mec-border-color-hover'); ?>
                        <?php echo $this->booking_button($event); ?>
                    </div>
                </div>
                ...
                <div class="event-carousel-type4-head clearfix">
                    ...
                    <div class="mec-event-hover-carousel-type4">
                        ...
                        <?php echo $this->main->get_normal_labels($event, $display_label).$this->main->display_cancellation_reason($event, $reason_for_cancellation); ?><?php do_action('mec_shortcode_virtual_badge', $event->data->ID); ?>
                        <div class="mec-btn-wrapper"><?php echo $this->display_link($event, ($this->main->m('event_detail', __('EVENT DETAIL', 'mec'))), 'mec-event-button'); ?><?php echo $this->booking_button($event); ?></div>
                    </div>
                </div>
                <?php endif; ?>
            </article>
