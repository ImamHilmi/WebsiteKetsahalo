        ...
        <div class="mec-fes-form-cntt">
            ...
            <div class="mec-meta-box-fields" id="mec-date-time">
                ...
                <div id="mec_meta_box_date_form">
                    ...
                    <h4><?php _e('Countdown Method', 'mec'); ?></h4>
                    <div class="mec-form-row">
                        <div class="mec-col-4">
                            <select name="mec[countdown_method]" id="mec_countdown_method" title="<?php esc_attr_e('Countdown Method', 'mec'); ?>">
                                <option value="global" <?php if('global' == $countdown_method) echo 'selected="selected"'; ?>><?php _e('Inherit from global options', 'mec'); ?></option>
                                <option value="start" <?php if('start' == $countdown_method) echo 'selected="selected"'; ?>><?php _e('Count to Event Start', 'mec'); ?></option>
                                <option value="end" <?php if('end' == $countdown_method) echo 'selected="selected"'; ?>><?php _e('Count to Event End', 'mec'); ?></option>
                            </select>
                        </div>
                    </div>
                    <?php endif; ?>
        ...
        <div class="mec-fes-form-sdbr">
            ...
            <div class="mec-meta-box-fields" id="mec-event-cost">
                ...
                <div id="mec_meta_box_cost_form">
                    <div class="mec-form-row">
                        <input type="<?php echo ($cost_type === 'alphabetic' ? 'text' : 'number'); ?>" class="mec-col-3" name="mec[cost]" id="mec_cost" value="<?php echo esc_attr($cost); ?>" placeholder="<?php _e('Cost', 'mec'); ?>" <?php echo ((isset($this->settings['fes_required_cost']) and $this->settings['fes_required_cost']) ? 'required' : ''); ?> />
                    </div>
                </div>
            </div>
            <?php endif; ?>
