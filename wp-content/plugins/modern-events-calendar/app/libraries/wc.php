        ...
        foreach($mec as $event_id => $b)
        {
            ...
            if(count($coupons))
            {
                ...
                $transaction['price_details']['details'][] = array(
                    'amount' => $wc_discount,
                    'description' => __('Discount by WC Coupon', 'mec'),
                    'type' => 'discount',
