...
class MEC_notifications extends MEC_base
{
    ...
    public function booking_rejection($book_id)
    {
        ...
        $subject = isset($this->notif_settings['booking_rejection']['subject']) ? __($this->notif_settings['booking_rejection']['subject'], 'mec') : __('booking rejected.', 'mec');
    ...
    */
    ...
    public function event_soldout($event_id, $book_id)
    {
        ...
        $subject = isset($this->notif_settings['event_soldout']['subject']) ? __($this->notif_settings['event_soldout']['subject'], 'mec') : __('Event is soldout!', 'mec');
    ...
    public function content($message, $book_id, $attendee = array())
    {
        ...
        $ical_export_link  = '<a href="' . $this->main->ical_URL_email($event_id, $book_id, get_the_date('Y-m-d', $book_id)) . '">'. __('+ iCal / Outlook export', 'mec') . '</a>';
